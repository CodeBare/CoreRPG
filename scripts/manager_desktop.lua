...
function setStackIconSizeAndSpacing(iw, ih, sw, sh)
	Debug.console("DesktopManager.setStackIconSizeAndSpacing - DEPRECATED - 2021-10-15 - Use DesktopManager.setSidebarDockButtonSize(w, h) and DesktopManager.setSidebarDockButtonOffset(l, t, r, b) instead.");
end
...
function registerStackShortcuts(aShortcuts)
	Debug.console("DesktopManager.registerStackShortcuts - DEPRECATED - 2021-10-15 - Use DesktopManager.registerSidebarToolButton(tButton, bFront) instead.");
end
function registerStackShortcut(iconNormal, iconPressed, tooltipText, className, recordName)
	Debug.console("DesktopManager.registerStackShort - DEPRECATED - 2021-10-15 - Use DesktopManager.registerSidebarToolButton(tButton, bFront) instead.");
end
function registerStackShortcut2(iconNormal, iconPressed, sTooltipRes, className, recordName, bFront)
	Debug.console("DesktopManager.registerContainerWindow - DEPRECATED - 2021-10-15 - Use DesktopManager.registerSidebarToolButton(tButton, bFront) instead.");
